...
static constexpr auto qt_meta_stringdata_ZN14TransferDialogE = QtMocHelpers::stringData(
    "TransferDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14TransferDialogE[] = {
...
Q_CONSTINIT const QMetaObject TransferDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14TransferDialogE.offsetsAndSizes,
    qt_meta_data_ZN14TransferDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14TransferDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TransferDialog, std::true_type>,
        // method 'on_transfer_confirmation_btn_clicked'
...
void *TransferDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14TransferDialogE.stringdata0))
