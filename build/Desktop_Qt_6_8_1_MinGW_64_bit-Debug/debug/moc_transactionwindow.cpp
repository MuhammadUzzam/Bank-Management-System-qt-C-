...
static constexpr auto qt_meta_stringdata_ZN17TransactionWindowE = QtMocHelpers::stringData(
    "TransactionWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17TransactionWindowE[] = {
...
Q_CONSTINIT const QMetaObject TransactionWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17TransactionWindowE.offsetsAndSizes,
    qt_meta_data_ZN17TransactionWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17TransactionWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TransactionWindow, std::true_type>
    >,
    nullptr
} };
...
void *TransactionWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17TransactionWindowE.stringdata0))
